...
class TasksController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/tasks')->with('success', 'Yapılacak iş listeye eklendi!');
    }
    ...
    public function update(Task $task, Request $request, $id)
    {
        ...
        return redirect('tasks')->with('success', 'Başarıyla güncellendi');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/tasks')->with('success', 'Yapılacak iş silindi');
    }
}
